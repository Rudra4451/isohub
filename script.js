...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  const Qs=[
    {q:"What will you mainly use your computer for?",opts:[
      {t:"Gaming & entertainment",i:"🎮",s:{w:3,u:1,m:0,l:1}},
      {t:"Work & office apps",i:"💼",s:{w:2,u:2,m:3,l:2}},
      {t:"Programming & dev",i:"💻",s:{w:1,u:3,m:3,l:1}},
      {t:"Browsing & casual use",i:"🌐",s:{w:2,u:2,m:2,l:3}},
    ]},
    {q:"How old is your computer?",opts:[
      {t:"Brand new (2021+)",i:"✨",s:{w:3,u:2,m:2,l:1}},
      {t:"A few years (2016–20)",i:"🗓",s:{w:2,u:3,m:1,l:2}},
      {t:"Old machine (pre-2016)",i:"🖥",s:{w:0,u:2,m:0,l:3}},
      {t:"It's a Mac",i:"🍎",s:{w:0,u:0,m:4,l:0}},
    ]},
    {q:"How tech-savvy are you?",opts:[
      {t:"Total beginner",i:"🌱",s:{w:3,u:1,m:3,l:3}},
      {t:"Know the basics",i:"👍",s:{w:2,u:2,m:2,l:3}},
      {t:"Pretty comfortable",i:"🔧",s:{w:2,u:3,m:2,l:2}},
      {t:"Advanced power user",i:"⚡",s:{w:1,u:3,m:2,l:2}},
    ]},
  ...
  const Rs={
    w:{name:"Windows 11",color:"#0ea5e9",icon:"🪟",
       desc:"Windows 11 is your perfect match! Great for gaming, has the widest software library, familiar interface, and excellent hardware support.",
       link:"windows11.html",btn:"bw"},
    u:{name:"Ubuntu Linux",color:"#f97316",icon:"🐧",
       desc:"Ubuntu is ideal for you! It's powerful, completely free, very secure, and has one of the largest communities to help you with anything.",
       link:"ubuntu.html",btn:"bu"},
    m:{name:"macOS Sequoia",color:"#a855f7",icon:"🍎",
       desc:"macOS is your match! Beautifully polished, incredibly secure, and perfectly integrated with the Apple ecosystem.",
       link:"macos.html",btn:"bm"},
    l:{name:"Linux Mint",color:"#10b981",icon:"🌿",
       desc:"Linux Mint is perfect for you! It looks and feels just like Windows, runs great on older hardware, and is completely free.",
